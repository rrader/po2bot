...
DOCUMENT_PROMPT = (
    ...
    "🔒 Ваші дані не передаються третім особам і використовуються виключно 1) для роботи бота та 2) підрахунку загальної площі власників 3) інформування про можливості голосування.\n"
